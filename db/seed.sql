...
INSERT INTO product (p_image, p_name, price, stock, p_description) 
values 
('https://cdn.shopify.com/s/files/1/0039/8426/1190/products/200971_474x.progressive.jpg?v=1553574495', 'SEM COLOR COAT SPRAY CAN', 15, 10, 'SEM COLOR COAT is formulated to match, restore or change color on most vinyl surfaces, flexible and rigid plastics, carpet and velour. Fade resistant and flexible, COLOR COAT is not a dye, but a permanent paint coating. 12 oz. aerosol'),
...
('https://cloudfront.zoro.com/product/prev/Z2Fwuzfo5oy.JPG', '3M 5301 Half-Face Respirator', 25, 200, 'Organic Vapor – Used for petrochemicals, chemical manufacturing, construction'),
('https://cloudfront.zoro.com/product/prev/Z3y2x_fo5oy.JPG', '3M™ 6000 Series Half Mask, M', 15, 50, 'Item: Half Mask Respirator, Facepiece Material: Thermoplastic Elastomer, Configured For: Dual Cartridge');
